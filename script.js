...
function redirectToProducts() {
    window.location.href = "products.html#ourProductSection";
}
...
//This function is called at the order to display the product selected and proceed to the checkout.
...
if (document.getElementById("radio1").checked = true) {
    ...
    // Adds a click event listener to manual navigation buttons
    document.querySelectorAll('.manual-btn').forEach(function (btn) {
        btn.addEventListener('click', function () {

            // Updates the count based on the button number clicked
            count = parseInt(this.htmlFor.replace('radio', ''));
